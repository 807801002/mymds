...
- 总的来说，`#run()` 的执行过程，就是如下一张图：![run](http://www.iocoder.cn/images/Netty/2018_05_10/01.png)
...
本文我们分享 EventLoop 的**处理 IO 事件**相关代码的实现。对应如下图的绿条 **process selected keys** 部分：![run](http://www.iocoder.cn/images/Netty/2018_05_10/01.png)
...
本文我们分享 EventLoop 的**执行任务**相关代码的实现。对应如下图的紫条 **run tasks** 部分：![run](http://www.iocoder.cn/images/Netty/2018_05_10/01.png)

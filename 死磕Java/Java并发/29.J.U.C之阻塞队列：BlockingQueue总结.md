# [J.U.C之阻塞队列：BlockingQueue总结](http://cmsblogs.com/?p=2440)

2017-10-04 分类：[死磕Java并发](http://cmsblogs.com/?cat=151) 阅读(12872)	评论(0) 

[[隐藏目录](http://cmsblogs.com/?p=2440#)]

- BlockingQueue
  - [ArrayBlockingQueue](http://cmsblogs.com/?p=2440#ArrayBlockingQueue)
  - [PriorityBlockingQueue](http://cmsblogs.com/?p=2440#PriorityBlockingQueue)
  - [DelayQueue](http://cmsblogs.com/?p=2440#DelayQueue)
  - [SynchronousQueue](http://cmsblogs.com/?p=2440#SynchronousQueue)
  - [LinkedTransferQueue](http://cmsblogs.com/?p=2440#LinkedTransferQueue)
  - [LinkedBlockingDeque](http://cmsblogs.com/?p=2440#LinkedBlockingDeque)
- [扩展阅读](http://cmsblogs.com/?p=2440#i)
...
[![img](https://gitee.com/chenssy/blog-home/raw/master/image/sijava/2018120832001.png)](https://gitee.com/chenssy/blog-home/raw/master/image/sijava/2018120832001.png)

## BlockingQueue

BlockingQueue接口实现Queue接口，它支持两个附加操作：获取元素时等待队列变为非空，以及存储元素时等待空间变得可用。相对于同一操作他提供了四种机制：抛出异常、返回特殊值、阻塞等待、超时：

[![img](https://gitee.com/chenssy/blog-home/raw/master/image/sijava/2018120832002.png)](https://gitee.com/chenssy/blog-home/raw/master/image/sijava/2018120832002.png)

# [J.U.C之AQS：同步状态的获取与释放](http://cmsblogs.com/?p=2197)

2017-03-13 分类：[死磕Java并发](http://cmsblogs.com/?cat=151) 阅读(21703)	评论(4) 

[[隐藏目录](http://cmsblogs.com/?p=2197#)]

- 独占式
  - [独占式同步状态获取](http://cmsblogs.com/?p=2197#i-2)
  - [独占式获取响应中断](http://cmsblogs.com/?p=2197#i-3)
  - [独占式超时获取](http://cmsblogs.com/?p=2197#i-4)
  - [独占式同步状态释放](http://cmsblogs.com/?p=2197#i-5)
- 共享式
  - [共享式同步状态获取](http://cmsblogs.com/?p=2197#i-7)
  - [共享式同步状态释放](http://cmsblogs.com/?p=2197#i-8)
- [参考资料](http://cmsblogs.com/?p=2197#i-9)
